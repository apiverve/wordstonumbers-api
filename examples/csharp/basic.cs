...
{
    class WordstoNumbersExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/wordstonumbers";

        /// <summary>
        /// Make a GET request to the Words to Numbers API
        /// </summary>
        static async Task<JsonDocument> CallWordstoNumbersAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;words&quot;] &#x3D; &quot;seven thousand six hundred and twenty&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Words to Numbers API...\n");

            var result = await CallWordstoNumbersAPI();
