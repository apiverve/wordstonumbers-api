...
namespace APIVerve.API.WordstoNumbers
{
    ...
    /// <summary>
    /// Client for the WordstoNumbers API
    /// </summary>
    public class WordstoNumbersAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/wordstonumbers";
        ...
        {
            { "words", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public WordstoNumbersAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordstoNumbersAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WordstoNumbersAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WordstoNumbersQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WordstoNumbersQueryOptions options)
        {
        ...
        public ResponseObj Execute(WordstoNumbersQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WordstoNumbersQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WordstoNumbersQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WordstoNumbersQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WordstoNumbersQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WordstoNumbersQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WordstoNumbersQueryOptions options)
        {
