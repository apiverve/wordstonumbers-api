...
```gradle
dependencies {
    implementation 'com.github.apiverve:wordstonumbers-api:1.1.13'
}
```
...
```java
import com.apiverve.wordstonumbers.WordstoNumbersAPIClient;
import com.apiverve.wordstonumbers.APIResponse;
import com.apiverve.wordstonumbers.APIException;

// Initialize the client
WordstoNumbersAPIClient client = new WordstoNumbersAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("words", "seven thousand six hundred and twenty");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/wordstonumbers](https://docs.apiverve.com/ref/wordstonumbers)
...
- **Documentation:** [https://docs.apiverve.com/ref/wordstonumbers](https://docs.apiverve.com/ref/wordstonumbers)
- **Issues:** [GitHub Issues](https://github.com/apiverve/wordstonumbers-api/issues)
