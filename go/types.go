// Package wordstonumbers provides a Go client for the Words to Numbers API.
//
// For more information, visit: https://apiverve.com/marketplace/wordstonumbers?utm_source=go&utm_medium=readme
package wordstonumbers
...
// Request contains the parameters for the Words to Numbers API.
//
// Parameters:
//   - words: string - The words to convert to numbers
type Request struct {
	Words string `json:"words,omitempty"` // Optional
}
...
// ResponseData contains the data returned by the Words to Numbers API.
type ResponseData struct {
	Number string `json:"number"`
	Words string `json:"words"`
	Ordinal string `json:"ordinal"`
	NumberOfDigitsNumeric int `json:"numberOfDigits_numeric"`
	NumberOfDigitsWords string `json:"numberOfDigits_words"`
	EachNumber []string `json:"eachNumber"`
}
