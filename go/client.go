...
const (
	baseURL        = "https://api.apiverve.com/v1/wordstonumbers"
	defaultTimeout = 30 * time.Second
)

// Client is the Words to Numbers API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Words to Numbers API client.
...
// Execute makes a request to the Words to Numbers API with typed parameters.
//
